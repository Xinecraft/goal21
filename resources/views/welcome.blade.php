...
<body>
	...
	<section class="section section--intro" id="intro">
			<div class="section__content section__content--fluid-width section__content--intro">
				<div class="intro">
					...
					<div class="intro__description">More Than 100000 people network with huge profits which will help you to fulfill your dreams.</div>
			...
			<div class="section__content section__content--fluid-width section__content--features">
				...
				<div class="grid grid--3col grid--features">
					...
					<div class="grid__item">
						...
						<p class="grid__text"><b>We have made the website look good on all devices (desktops, tablets, and phones), so that you can work with an ease.</b></p>
					</div>
					...
					<div class="grid__item">
						...
						<p class="grid__text"><b>We have learnt how to provide the best service for our customers so that they can grow in huge quantity with lower struggle.</b></p>
					</div>
					...
					<div class="grid__item">
						...
						<p class="grid__text"><b>We have seperated the tasks so it will be easier for you to complete it.</b></p>
					</div>	
			...
			<div class="section__content section__content--fluid-width section__content--about">
				<div class="grid grid--5col grid--about">
					...
					<div class="grid__item grid__item--x2">
						...
						<p class="grid__text"><b>Simplicity and higher returns is what we are known for, A simple design dashboard with all features.</b></p>
						<ul class="grid__list">
			...
			<div class="section__content section__content--fluid-width section__content--about">
				<div class="grid grid--5col grid--about">
					...
					<div class="grid__item grid__item--x2 grid__item--floated-right">
						...
						<p class="grid__text"><b>No need to Investment any money to start work with this plan. just need to open account and start work to earn money. Goal-21 is the one where no any investment needed to start work.</b></p>
						<ul class="grid__list">
			...
			<div class="section__content section__content--fluid-width section__content--about">
				<div class="grid grid--5col grid--about">
					...
					<div class="grid__item grid__item--x2">
						...
						<p class="grid__text"><b>Our Matrix and Autofill Plans are just way ahead then any provider in market, Simple, High returns, Instant payouts just make your work more easier.</b></p>
						<ul class="grid__list">
							<li><b>Higher Returns.</li> 
							<li>Not like other providers, Slow dashboard.We have made it in such a way that it responses in 1 click.</li> 
	...
	<section class="section" id="pricing">
			...
			<div class="section__content section__content--fluid-width section__content--padding">
				...
				<div class="section__description section__description--centered">
				We believe we have created the most efficient Work from home business that will give the highest benefits with a seal of trust.
				</div>
					...
					<div class="pricing">
						...
						<div class="pricing__plan">
							...
							<div class="pricing__values">
								...
								<div class="pricing__value pricing__value--hide pricing__value--hidden"><span></span>12006 <b></b></div>
							</div>	
						...
						<div class="pricing__plan pricing__plan--popular">
							...
							<div class="pricing__values">
								...
								<div class="pricing__value pricing__value--hide pricing__value--hidden"><span></span>7922 <b></b></div>
							</div> 
						...
						<div class="pricing__plan">
							...
							<div class="pricing__values">
								...
								<div class="pricing__value pricing__value--hide pricing__value--hidden"><span></span>56500 <b></b></div>
							</div>
			...
			<div class="footer__content footer__content--fluid-width footer__content--svg">
				...
				<div class="grid grid--5col">
					...
					<div class="grid__item grid__item--x2">
						...
						<p class="grid__text grid__text--copyright">Copyright &copy; 2019 Goal-21 <br />All Rights Reserved. Proudly made in India by Aystor </p>
