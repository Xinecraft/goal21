...
@section('content')
    ...
    <div class="row w-100">
        <div class="col-lg-6 mx-auto card">
            <div class="card-body">
                <h2 class="text-center mb-4 card-title">EDIT TASK ID: {{ $task->id }}</h2>
                <div class="auto-form-wrapper">
                    ...
                    <div class="form-group row">
                        <label for="credit_inr"
                               class="col-md-4 col-form-label text-md-right">{{ __('Reward (₹)') }}</label>

                        <div class="col-md-7">
                            {{ Form::text('credit_inr', null, ['class' => 'form-control', 'required', 'placeholder' => '₹0 - ₹1000']) }}
                    ...
                    <div class="form-group row">
                        <label for="wait_in_seconds"
                               class="col-md-4 col-form-label text-md-right">{{ __('Wait in Seconds') }}</label>

                        <div class="col-md-7">
                            {{ Form::number('wait_in_seconds', null, ['class' => 'form-control', 'required']) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            {{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Any description here if any...', 'cols' => '30', 'rows' => '6']) }}
                    ...
                    <div class="form-group row">
                        <div class="col-md-7 offset-4">
                            <button type="submit" class="btn btn-primary submit-btn btn-block">Update Task</button>
                        </div>
                    </div>
