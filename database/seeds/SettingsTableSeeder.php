    ...
    public function run()
    {
        \DB::table('site_settings')->insert([
            ...
            [
                ...
                'setting_display' => 'GoListTask Banner 1 (300x250)',
                'value' => 'https://via.placeholder.com/300x250?text=300x250+Half+Page+Ad',
                'created_at' => \Carbon\Carbon::now(),
                'updated_at' => \Carbon\Carbon::now(),
            ],
            [
                'setting' => 'golisttask_ad_banner_2',
                'setting_display' => 'GoListTask Banner 2 (300x250)',
                'value' => 'https://via.placeholder.com/300x250?text=300x250+Half+Page+Ad',
                'created_at' => \Carbon\Carbon::now(),
                'updated_at' => \Carbon\Carbon::now(),
            ],
            ...
            [
                'setting' => 'allow_upgradation_of_accounts',
                'setting_display' => 'Enable Upgradation of Accounts',
                'value' => 'yes',
                'created_at' => \Carbon\Carbon::now(),
                'updated_at' => \Carbon\Carbon::now(),
            ],
