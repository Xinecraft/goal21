...
class PaymentVerified extends Notification
{
    ...
    {
        return (new MailMessage)->markdown('emails.notifications.paymentverified',['payment' => $this->payment])
            ->subject('Payment to '.$this->payment->receiver->full_name.' is Verified');
    }
